...
export default function HipDelivers() {
  ...
  return (
    <div className="bg-white border-b-4 border-zinc-300 relative flex h-svh max-h-[800px] flex-col">
      ...
      <div
        className={`relative top-24 flex justify-center text-black duration-1000 ${inView ? "-translate-y-24 opacity-100" : "opacity-0"}`}
      >
        <div className="relative max-w-sm z-50 text-center">
          <h1 className="mt-16 text-xl font-semibold">هیپ‌فوم</h1>
